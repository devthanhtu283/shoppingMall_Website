...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-168560N;Database=ABCDMall;user id=sa;password=lethanhtu2803;trusted_connection=true;encrypt=false");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ACCOUNT__3213E83FAEE61622");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CATEGORY__3213E83F332F734F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__FEEDBACK__3213E83FC7F42B81");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__NEWSGALL__3213E83F56E8D93A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PRODUCT__3213E83F7FBD5F21");
            ...
            entity.HasOne(d => d.IdcategoryNavigation).WithMany(p => p.Products)
                ...
                .HasConstraintName("FK__PRODUCT__idcateg__5535A963");

            entity.HasOne(d => d.IdsaleNavigation).WithMany(p => p.Products)
                .HasForeignKey(d => d.Idsale)
                .HasConstraintName("FK__PRODUCT__idcateg__5441852A");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SALE__3213E83F486C395B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SHOP__3213E83F51DA30BB");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Shops)
                ...
                .HasConstraintName("FK__SHOP__categoryId__4F7CD00D");
        });
